...
/*DLV_CAVES4*/		{      24, FALSE,   DTYPE_CAVES,     DGT_CAVES,     TMUSIC_L3,   LFILE_L3,           10,      10, "Caves 4",
						"Levels\\L3Data\\L3_%d.pal",     "gendata\\Cut3.CEL",     "gendata\\Cut3.pal",             FALSE,            43, 50,          32,          0,             0,                        WRPT_NONE,    SPT_NONE,
						{ MT_DRHINO, MT_BACID, MT_RFAT, MT_WTHIN, MT_BGARG, MT_NMEGA, MT_DMEGA, MT_NSNAKE, MT_XTHIN, MT_RSNAKE, MT_NBLACK, MT_NSUCC, MT_BMEGA, MT_XACID, MT_GTHIN, MT_INVALID },
					},
/*DLV_HELL1*/		{      26, FALSE,   DTYPE_HELL,      DGT_HELL,      TMUSIC_L4,   LFILE_L4,           12,      16, "Hell 1",
						...
						{ MT_DMEGA, MT_NSNAKE, MT_XTHIN, MT_RSNAKE, MT_NBLACK, MT_NSUCC, MT_BMEGA, MT_XACID, MT_GTHIN, MT_WTHIN, MT_RMEGA, MT_BSNAKE, MT_RBLACK, MT_GBLACK, MT_GSUCC, MT_NMAGE, MT_INVALID },
					},
